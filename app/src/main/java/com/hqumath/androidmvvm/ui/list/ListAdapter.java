...
import com.hqumath.androidmvvm.databinding.ListItemBinding;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.MyViewHolder> {
    ...
    public ListAdapter(@NonNull ClickCallback clickCallback) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private MyViewHolder(ListItemBinding binding) {
