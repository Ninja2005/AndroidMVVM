 ...
 * ****************************************************************
 */
public class StarredReposSource extends PageKeyedDataSource<Long, ReposEntity> {
    ...
    public StarredReposSource(int pageSize) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Long> params, @NonNull LoadInitialCallback<Long,
        ...
        try {
            Response<List<ReposEntity>> response =
                    RetrofitClient.getInstance().getRetrofit().create(MyApiService.class).getStarred(params.requestedLoadSize, 1).execute();
    ...
    public void loadAfter(@NonNull LoadParams<Long> params, @NonNull LoadCallback<Long, ReposEntity> callback) {
        networkState.postValue(NetworkState.LOADING);
        RetrofitClient.getInstance().getRetrofit().create(MyApiService.class).getStarred(params.requestedLoadSize,
                params.key)
